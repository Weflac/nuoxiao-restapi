# Generated by Django 2.0 on 2018-06-07 18:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateTime', models.DateTimeField(verbose_name='日期')),
                ('links', models.IntegerField(verbose_name='点赞数')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nuoxiao.Article', verbose_name='文章')),
            ],
        ),
        migrations.CreateModel(
            name='Discuss',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission', models.ManyToManyField(to='nuoxiao.Permission', verbose_name='权限')),
            ],
        ),
        migrations.CreateModel(
            name='Snippet',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateTime', models.DateTimeField(verbose_name='时间')),
                ('organization', models.ManyToManyField(to='nuoxiao.Organization', verbose_name='组织')),
                ('roles', models.ManyToManyField(to='nuoxiao.Role', verbose_name='角色')),
            ],
        ),
        migrations.CreateModel(
            name='UserToken',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='nuoxiao.Users', verbose_name='用户')),
            ],
        ),
        migrations.AddField(
            model_name='themearticle',
            name='author',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nuoxiao.Users', verbose_name='作者'),
        ),
        migrations.AddField(
            model_name='themearticle',
            name='theme',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nuoxiao.Theme', verbose_name='园子'),
        ),
        migrations.AddField(
            model_name='theme',
            name='author',
        ...
        migrations.AddField(
            model_name='discusstopic',
            name='themeBlog',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='nuoxiao.ThemeArticle', verbose_name='主题'),
        ),
        migrations.AddField(
            model_name='discuss',
            name='author',
        ...
        migrations.AddField(
            model_name='discuss',
            name='topic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nuoxiao.DiscussTopic', verbose_name='讨论主题'),
        ),
        migrations.AddField(
            model_name='commons',
            name='author',
        ...
        migrations.AddField(
            model_name='article',
            name='garden',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nuoxiao.Garden', verbose_name='园子'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(to='nuoxiao.Tags', verbose_name='标签'),
        ),
    ]
